...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "90D28"  # Playfab Title Id
        self.SecretKey: str = "17OYWF149QOGN5ZNOBK7EIORHQSGUYBJJU5XMNUBFWG9T6NWY5"  # Playfab Secret Key
        self.ApiKey: str = "OC|1110288428839970|dddd5d721c866627d44846cb5c4c9021"  # App Api Key (Oculus/Graph API)
